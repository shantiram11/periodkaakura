				...
				if( $Powerpress['set_size'] == 0 || $Powerpress['set_duration'] == 0 )
				{
					...
					else
					{
                        if (!empty($Powerpress['url']) ) {
                            ...
                            if (in_array($media_hostname, array('0.0.0.0', '127.0.0.1', 'localhost', '[::]', '0x7f000001/', '0xc0a80014/')) || filter_var($media_hostname, FILTER_VALIDATE_IP) || !preg_match('/[a-zA-Z]/i', $media_hostname)) {
