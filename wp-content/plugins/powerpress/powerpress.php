...
define('POWERPRESS_VERSION', '11.0.12' );
...
function powerpress_rss2_head()
{
	...
	if( !empty($Feed['email']) && !empty($Feed['pp_enable_email']) && $Feed['pp_enable_email'] == 1)
	{
	...
	if( !defined('POWERPRESS_RAWVOICE_RSS') || POWERPRESS_RAWVOICE_RSS != false )
	{
        ...
        elseif (isset($Feed['podcast_guid']) && UUID::is_valid($Feed['podcast_guid']))
