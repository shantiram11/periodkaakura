	    ...
	    switch ($directory) {
            ...
            case 'google':
                $googleUrl =  'https://www.google.com/podcasts?feed='.powerpress_base64_encode($feed_url);?>
                    ...
                    <h2 class="pp-heading">
                        <span id="google-icon" class="destinations-side-icon"></span>
                        <span class="directory-summary-head"><?php echo __('Google', 'powerpress'); ?></span>
                        <?php powerpress_settings_save_button(); ?>
                    </h2>
                    <?php if ($link_at_top) { ?>
            ...
            case 'stitcher': ?>
                    ...
                    <h2 class="pp-heading">
                        <span id="stitcher-icon" class="destinations-side-icon"></span>
                        <span class="directory-summary-head"><?php echo __('Stitcher', 'powerpress'); ?></span>
                        <?php powerpress_settings_save_button(); ?>
                    </h2>
...
<div style="max-width: 75%;">
    <div class="destinations-icon-links d-flex flex-wrap justify-content-between">
        ...
        <div id="destinations-google-tab" onclick="sideNav(event, 'destinations-google')" class="pp-sidenav-tablinks destinations-link d-inline-block mr-4 mb-3 text-center align-top" style="max-width: 70px;">
            <i class="<?php echo empty($FeedSettings['google_url']) ? 'grey-icon ' : ''; ?>subscribe-icons-larger google"></i>
            <small>Google</small>
        </div>
        ...
        <div id="destinations-stitcher-tab" onclick="sideNav(event, 'destinations-stitcher')" class="pp-sidenav-tablinks destinations-link d-inline-block mr-2 mb-3 text-center align-top" style="max-width: 70px;">
            <i class="<?php echo empty($FeedSettings['stitcher_url']) ? 'grey-icon ' : ''; ?>subscribe-icons-larger stitcher"></i>
            <small>Stitcher</small>
        </div>
