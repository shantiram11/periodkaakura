...
function powerpress_meta_box($object, $box)
{
    ...
    $titles = array("info" => esc_attr(__("Episode Info", "powerpress")), "artwork" => esc_attr(__("Episode Artwork", "powerpress")), "website" => esc_attr(__("Website Display", "powerpress")), "advanced" => esc_attr(__("Advanced", "powerpress")), 'chapters' => esc_attr(__("Chapter Builder", "powerpress")));
    ...
    chapters_tab($FeedSlug, $object, $GeneralSettings, $PCITranscript, $PCITranscriptURL, $PCIChapters, $PCIChaptersManual, $PCIChaptersURL, $PCISoundbites, $ExtraData);
    echo "</div>";
    echo "</div>";
    if ($EnclosureURL) {
