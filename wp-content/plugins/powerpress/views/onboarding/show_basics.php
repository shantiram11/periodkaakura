                    ...
                    <div class="pp_col">
                        <form id="basic-feed" enctype="multipart/form-data" action="" method="post">
                            ...
                            <div class="pp_leftline">
                                ...
                                <div class="pp_form-group">
                                    <div class="pp_input-field-thirds">
                                        <textarea id="podcast-description" type="text" name="pp_start[description]" class="pp_outlined" placeholder="<?php echo __('Enter a brief description of your show.', 'powerpress'); ?>"><?php echo htmlspecialchars($FeedSettings['description']); ?></textarea>
                            ...
                            <div class="pp_leftline">
                                ...
                                <div class="pp_flex-grid" id="showbasics_artwork">
                                    <div class="pp_col" id="showbasics_artwork_upload" style="margin-left: 0;">
                                        <input type="text" id="filePath" readonly class="pp_outlined" style="margin: 1rem 0 1ch 0;" placeholder="Upload your show artwork" <?php echo empty($FeedSettings['itunes_image']) ? '' : "value='" . esc_attr($FeedSettings['itunes_image']) . "'"  ?>>
