...
function powerpress_do_subscribe_widget($settings, $PowerPressSettings)
{
	...
	$link_counter = 0;
            ...
            if (!empty($settings['subscribe_feature_gp_shortcode'])) {
                $link_counter++;
                $html .= '<a href="' . esc_url($googleUrl) . '" class="pp-sub-btn' . htmlspecialchars($settings['subscribe_widget_shape']) . ' pp-sub-gp" target="_blank" title="' . esc_attr(__('Subscribe on Google Podcasts', 'powerpress')) . '"><span class="pp-sub-ic"></span>' . esc_html(__('Google Podcasts', 'powerpress')) . '</a>';
            }
            ...
            {
                $link_counter++;
                $html .= '<a href="'.  esc_url( $settings['stitcher_url'] ) .'" class="pp-sub-btn'. htmlspecialchars($settings['subscribe_widget_shape']) .' pp-sub-stitcher" target="_blank" title="'.  esc_attr( __('Subscribe on Stitcher', 'powerpress') ) .'"><span class="pp-sub-ic"></span>'.  esc_html( __('Stitcher', 'powerpress') ) .'</a>';
            }
