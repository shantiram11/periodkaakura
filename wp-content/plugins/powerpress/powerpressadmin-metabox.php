...
function chapters_tab($FeedSlug, $object, $GeneralSettings, $PCITranscript, $PCITranscriptURL, $PCIChapters, $PCIChaptersManual, $PCIChaptersURL, $PCISoundbites, $ExtraData)
{
    ...
    <script>
        ...
        let <?php echo $FeedSlug?>_chapterCount = <?php echo 0; ?>;
        jQuery(document).ready(function() {
            jQuery("#<?php echo $FeedSlug?>-add-chapter").on('click', function () {
                <?php echo $FeedSlug?>_chapterCount += 1;
...
function notes_tab($FeedSlug, $object, $GeneralSettings, $PCITranscript, $PCITranscriptURL, $PCIChapters, $PCIChaptersURL, $PCISoundbites, $ExtraData)
{
    ...
    <div id="notes-<?php echo $FeedSlug; ?>" class="pp-tabcontent">
        ...
        <script>
            ...
            let <?php echo $FeedSlug; ?>_currentSoundBiteCount = <?php echo $currentSoundbiteCount; ?>;
            ...
            jQuery(document).ready(function() {
                ...
                jQuery(document).on('click',"[name*='remove-soundbite-']",function (e) {
                    <?php echo $FeedSlug; ?>_currentSoundBiteCount -= 1;
                ...
                jQuery("[name='newsoundbite']").on('click', function () {
                    ...
                    if (jQuery("[name='Powerpress[<?php echo $FeedSlug; ?>][soundbite-" + <?php echo $FeedSlug; ?>_currentSoundBiteCount + "-start]']").length) {
                        jQuery("[name='Powerpress[<?php echo $FeedSlug; ?>][soundbite-" + <?php echo $FeedSlug; ?>_currentSoundBiteCount + "-start]']").val("");
                        jQuery("[name='Powerpress[<?php echo $FeedSlug; ?>][soundbite-" + <?php echo $FeedSlug; ?>_currentSoundBiteCount + "-duration]']").val("");
                        jQuery("[name='Powerpress[<?php echo $FeedSlug; ?>][soundbite-" + <?php echo $FeedSlug; ?>_currentSoundBiteCount + "-title]']").val("");
                        jQuery("#soundbite-"+<?php echo $FeedSlug; ?>_currentSoundBiteCount+"-container").css({"visibility": "visible", "position": "static"});
                    } else {
                        let newHTML = '<div id="<?php echo $FeedSlug; ?>-soundbite-' + <?php echo $FeedSlug; ?>_currentSoundBiteCount + '-container">' +
                            '<div class="row" style="margin-left: -15px !important; margin-right: -15px !important;">' +
                            '<div class="col-lg-2">' +
                            '<label for="<?php echo $FeedSlug; ?>-soundbite-' + <?php echo $FeedSlug; ?>_currentSoundBiteCount + '-start" style="margin: 0;">Start Time (seconds)</label>' +
                            '</div>' +
                            '<div class="col-lg-2">' +
                            '<label for="<?php echo $FeedSlug; ?>-soundbite-' + <?php echo $FeedSlug; ?>_currentSoundBiteCount + '-duration" style="margin: 0;">Duration (seconds)</label>' +
                            '</div>' +
                            '<div class="col-lg-5">' +
                            '<label for="<?php echo $FeedSlug; ?>-soundbite-' + <?php echo $FeedSlug; ?>_currentSoundBiteCount + '-title" style="margin: 0;">Title</label>' +
                            '</div>' +
                            '<div class="col-lg-1"></div>' +
                            '</div>' +
                            '<div class="row" style="display: flex; align-items: center;">' +
                            ...
                            '<div class="row" style="display: flex; align-items: center; margin-bottom: 15px; margin-left: -15px !important; margin-right: -15px !important;">' +
                            '<div class="col-lg-2">' +
                            '<div class="time-container"><input required pattern="([0-9]{2}|[0-9]{1}):([0-9]{2}|[0-9]{1}):([0-9]{2}|[0-9]{1})" style="width: 100%;" name="Powerpress[<?php echo $FeedSlug; ?>][soundbite-' + <?php echo $FeedSlug; ?>_currentSoundBiteCount + '-start]" class="time-input" type="text" value="00:00:00" /></div>' +
                            '</div>' +
                            '<div class="col-lg-2">' +
                            '<div class="time-container"><input required pattern="([0-9]{2}|[0-9]{1}):([0-9]{2}|[0-9]{1}):([0-9]{2}|[0-9]{1})" style="width: 100%;" name="Powerpress[<?php echo $FeedSlug; ?>][soundbite-' + <?php echo $FeedSlug; ?>_currentSoundBiteCount + '-duration]" class="time-input" type="text" value="00:00:00" /></div>' +
                            '</div>' +
                            '<div class="col-lg-5">' +
                            '<input type="text" value="" name="Powerpress[<?php echo $FeedSlug; ?>][soundbite-' + <?php echo $FeedSlug; ?>_currentSoundBiteCount + '-title]" class="pp-ep-box-input" style="font-size: 11px;" />' +
                            '</div>' +
                            '<div class="col-lg-1 pl-0">' +
                            '<button class="float-left pl-0" type="button" style="border: none; background: inherit; color: red; font-size: 25px;" id="<?php echo $FeedSlug; ?>-remove-soundbite-' + <?php echo $FeedSlug; ?>_currentSoundBiteCount + '" name="<?php echo $FeedSlug; ?>-remove-soundbite-' + <?php echo $FeedSlug; ?>_currentSoundBiteCount + '">&times;</button>' +
                            '</div>' +
                            '</div>' +
                            '</div>' +
                            '</div>' +
                            '</div>';
                        let prevId = '#<?php echo $FeedSlug; ?>-soundbite-' + (<?php echo $FeedSlug; ?>_currentSoundBiteCount - 1) + '-container';
