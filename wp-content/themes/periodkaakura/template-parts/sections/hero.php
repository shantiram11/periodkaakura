            ...
            <div class="hero-right mt-[60px]">
                <div>
                    <div class="owl-carousel owl-theme" id="hero-slider">
                        <div class="item"><img class="m-auto cover-image"
                                               src="<?php echo get_template_directory_uri() . '/assets/img/period.png' ?>"
                                               alt="">
                        </div>
                        <div class="item"><img class="m-auto cover-image"
                                               src="<?php echo get_template_directory_uri() . '/assets/img/temp/hero1.png' ?>"
                                               alt="">
                        </div>
                    </div>
                </div>
