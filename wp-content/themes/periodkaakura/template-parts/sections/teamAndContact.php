<section class="section-team-and-contact my-10">
    ...
    <div class="container">
        ...
        <p class=" mt-2 mb-4 text-[rgba(18, 18, 18, 0.50)] font-semibold">Period Kaa Kura is a personal initiation of
            the creators. For
            collaboration, please reach us at: <a class="text-[#9C1112]" href="mailto:periodkaakura@gmail.com">periodkakura@gmail.com</a>
        </p>
    </div>
...
<!--                </form>-->
            ...
            <div class="submit-form mt-10 sm:flex items-center justify-between">
                ...
                <div class="flex gap-6">
                    <p class="text-black text-base font-bold">Connect with us in the social medias</p>
                    <a href="#">
                        <div class="icon-wrapper">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20"
                                 fill="none">
