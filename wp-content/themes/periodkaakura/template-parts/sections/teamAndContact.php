<section class="section-team-and-contact my-10">
    ...
    <div class="container">
        ...
        <p class=" mt-2 mb-4 text-base font-semibold">Period Kaa Kura is a personal initiation of the creators. For
            collaboration, please reach us at: <a class="text-blue-800" href="mailto:periodkaakura@gmail.com">periodkakura@gmail.com</a>
        </p>
    </div>
    <div class="contact-section">
        <div class="container">
            <form class="form mt-9" action="">
                ...
                <input class="mt-6 h-9 p-2" type="email" placeholder="Your Email" name="email">
                <!-- Use a different name attribute for the email input -->
                <textarea rows="6" class="mt-6 p-2" placeholder="Your Message" name="message"></textarea>
                <!-- Use a different name attribute for the textarea -->
                <button class="px-4 mt-10 text-black flex" type="submit"> <!-- Adjust the margin here -->
                    <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 17 17" fill="none">
                        <g clip-path="url(#clip0_1536_140)">
                            ...
                            <path d="M15.5834 1.41663L10.625 15.5833L7.79169 9.20829L1.41669 6.37496L15.5834 1.41663Z"
                                  stroke="#2F7D40" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                        </g>
                        <defs>
