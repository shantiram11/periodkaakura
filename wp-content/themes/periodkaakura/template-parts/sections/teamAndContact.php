    ...
    <div class="team-section">
        <div class="container" id="team">
            <div class="relative overflow-x-visible pt-[70px] pb-[30px]">
                ...
                ?>
                <!--            <div class="md:flex gap-8 mt-10 mb-2 md:mb-0">-->
                <!--                <img class="w-[180px]" src="-->
                <?php //echo get_template_directory_uri() . '/assets/img/temp/host.svg' ?><!--"-->
                <!--                     alt="">-->
                <!---->
                <!--                <div>-->
                <!--                    <div class="md:flex justify-start items-center gap-9">-->
            ...
            <div class="submit-form mt-10 sm:flex items-center justify-between">
                <button id="customSubmitButton" class="px-8  text-black flex" type="submit">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="27" height="27" viewBox="0 0 27 27" fill="none">
                        <path d="M25.5833 1.41669L17.125 25.5834L12.2916 14.7084L1.41663 9.87502L25.5833 1.41669Z" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                    Send
                </button>
