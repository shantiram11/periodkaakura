<section class="flex flex-col justify-center items-center gap-12  max-sm:px-0  w-full px-44">
  <div class="flex flex-row justify-center items-center w-full gap-24 bg-black text-white p-8 rounded-lg max-sm:flex-col max-md:flex-col">
    <img src="path/to/your/music.png" alt="">
    <div class="flex flex-col justify-start gap-4 w-full">
      ...
      <div class="flex flex-row justify-center items-center gap-8 py-8">
        <img src="path/to/your/like.png" alt="">
        <img src="path/to/your/share.png" alt="">
        <img src="path/to/your/volume.png" alt="">
      </div>
    </div>
  </div>


  <div className='flex flex-row justify-center w-full items-center gap-4 max-sm:flex-col max-md:flex-col'>
    <div class="flex flex-col w-full">
      <form>
